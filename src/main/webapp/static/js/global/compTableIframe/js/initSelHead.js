 ...
 */
document.write("<script src='statics/compTableIframe/js/jquery-1.8.3.min.js'></script>");
document.write('<link rel="stylesheet" href="statics/compTableIframe/css/cpTableHead.css"/>');
//默认的交易商和货币对
var productsStrBase = "axitrader-35,fxpro-1,xm-2,avatrade-31,thinkforex-5,gmi-15,markets-17,ads-44,forexclub-8,fxcm-4,ifx-7,"
    ...
    +"vantagefx-14,lmax-9";
var pairsStrBase = "eurusd-1,usdjpy-2";
...
window.onload = function(){
    initSelHead(iframeId,selItemsID);
};

//初始化头部的代码，默认是有选择交易商和货币对的头部的
function initSelHead(containerID,selItemsID){
...
function initIframe(proAndPairStr,rowCount){
    var baseStr = 'statics/compTableIframe/cpTable.html?prosAndPairs&';
