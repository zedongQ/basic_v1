...
//默认的交易商和货币对
var productsStrBase = "axitrader-35,fxpro-1,xm-2,avatrade-31,thinkforex-5,gmi-15,markets-17,ads-44,forexclub-8,fxcm-4,ifx-7,"
	+"oanda-12,aetos-13,forex.com-11,gkfx-10,exness-6,"
    +"vantagefx-14,lmax-9";
var pairsStrBase = "eurusd-1,usdjpy-2,gbpusd-3,audusd-9,gbpjpy-24,usdcad-30,gold-36,silver-37";
var proBaseStr = "35&1&2&31&5&15&17&44&8&4&7&12&13&11&10&6&14&9";
var pairBaseStr = "&&&1&2&3&9&24&30&36&37";
//全部的交易商和货币对
...
function initSelHead(containerID){
    var html ='<div class="bj-selItemLeft"><div class="bj-selILText">外汇交易商实时点差对比</div><div class="bj-selILIcon">' +
        '<img id="popQuesPic" src="imgs/questionIcon.png"/><div id="popTipbox" class="bj-selILITip">' +
    ...
    for(var i=0;i<pairsLabels.length;i++){
        pairsLabels[i].onclick = function(event){
            ...
            if(count>=9){
                ...
                selTooMuchTip.innerHTML = "一次最多比较八个货币对";
            }else if(count<=0){
                selTooMuchTip.style.display = "block";
...
function initIframe(proAndPairStr,rowCount){
    var baseStr = 'http://123.59.52.95:8080/compTableIframe/cpTableNoRPicW838.html?prosAndPairs&';
    var paramStr = baseStr + proAndPairStr;
    var iframeHeight = rowCount*69 + 38 + 50 +1;
    var iframeWidth = 919 + "px";
