...
document.write("<script src='js/cpTable.js?version=1.6'></script>");
document.write("<script src='js/CptCell.js'></script>");
document.write("<script src='js/CptRow.js'></script>");
//默认的交易商和货币对
//var proAndPairStr = "35&1&2&31&5&15&3&44&8&4&7&12&13&11&10&6&14&9&&&1&3";
//全部的交易商和货币对
var products =["axitrader-35","fxpro-1","xm-2","avatrade-31","ThinkMarkets-5","abs-46","fibo-47","gmi-15","markets-17","markets-3","ads-44","forexclub-8","fxcm-4","ifx-7",
    ...
    "infinox-41","xcoq-42","ig-43" ,"TeraFX-45","hycm-49","fx88-50"
];
...
function initOneTable(){
    ...
    var param = {
		...
		pros:proAndPair.proArray,
        serverPath : 'ws://119.28.20.55:7002',
        //url : 'http://123.59.52.95:8080/quotechart/dchac.do',
        url : '../../diancha/cashBackById?accttypes='+proAndPair.proArray,
